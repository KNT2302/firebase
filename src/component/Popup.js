...
const Content = ({ handleTogglePopup, getChildren, resetState }) => {
  ...
  return (
    ...
    <div style={{ position: 'absolute', top: 'calc(0% + 1em)', left: '50%', transform: 'translate(-50%, 0%)', opacity: `${isFadedIn ? "1" : '.5'}`, background: 'white', borderRadius: '3px', transition: '0.15s', backgroundColor: 'lightpink',zIndex:'1' }}>
